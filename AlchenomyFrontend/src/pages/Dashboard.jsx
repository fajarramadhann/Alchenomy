                        ...
                        <div className="space-y-3">
                            ...
                            <div className="p-6 bg-[#001524] text-white rounded-lg h-[250px] flex flex-col">
                                ...
                                <div className="flex gap-2 mt-auto">
                                    <button className="px-4 py-2 border border-white/20 rounded text-white text-sm">
                                        Borrow more
                                    </button>
                        ...
                        <div className="md:sticky md:top-24 space-y-3">
                            ...
                            <div className="p-6 bg-[#001524] text-white rounded-lg">
                                ...
                                <div className="mt-10">
                                    ...
                                    <button className="w-full bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded text-white">
                                        Stable your Collateral
                                    </button>
